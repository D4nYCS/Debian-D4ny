...
nala install neofetch flameshot git psmisc mangohud vim lxappearance papirus-icon-theme lxappearance fonts-noto-color-emoji lightdm -y
...
nala install apt-transport-https curl wget gpg -y
